...
public interface ShopRepo extends JpaRepository<Shop, Integer> {
     ...
     * for common DAO methods allowing for the removal of the DAO implementation
    ...
    //when we are using the Query annotation you have to add the wildcard (?) with the param numbers
    //that indicates the index of the values
